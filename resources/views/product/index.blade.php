                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Manage your product inventory</p>
                        </div>
                        
                        {{-- Fitur Tambah Produk Dibungkus Gate 'manage-product' --}}
                        @can('manage-product')
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-150">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                {{-- Tombol View (Semua user boleh lihat) --}}
                                                ...
                                                {{-- Tombol Edit Dibungkus Policy 'update' --}}
                                                @can('update', $product)
                                                ...
                                                {{-- Tombol Delete Dibungkus Policy 'delete' --}}
                                                @can('delete', $product)
